...
for filename,labels in total_csv_annotations.items():
    ...
    shutil.copy(os.path.join(image_raw_parh,filename),os.path.join(image_save_path))
    ...
    for l in labels:
        ...
        f.write(f'{class_id:d} {box_center_x:.6f} {box_center_y:.6f} {box_width:.6f} {box_height:.6f}\n')
    f.close()
